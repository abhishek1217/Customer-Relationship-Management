...
if ( isset($_POST['id']) && isset($_POST['Name']) && isset($_POST['Phone_No'])
     && isset($_POST['Product']) && isset($_POST['Priority']) && isset($_POST['FollowUp'])) {

    // Data validation
    if ( strlen($_POST['id']) < 1 || strlen($_POST['Name']) < 1 || strlen($_POST['Phone_No']) < 1 || strlen($_POST['Product']) < 1 || strlen($_POST['Priority']) < 1) {
